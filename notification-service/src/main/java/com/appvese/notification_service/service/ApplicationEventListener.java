...
//             groupId = "notification-group-app-created",
...
//                     (messageJson.contains("\"name\"") ? "parsed_name_placeholder" : "unknown_name"), 
//                     e.getMessage(), e);
//         } catch (Exception e) { 
