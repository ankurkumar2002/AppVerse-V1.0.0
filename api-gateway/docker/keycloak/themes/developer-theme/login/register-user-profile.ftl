...
<head>
    ...
    <title>Create Developer Account | AppVerse</title>
...
<body>
    ...
    <div class="register-wrapper">
        ...
        <div class="card">
            ...
            <p class="subtitle">
                Start building and publishing applications on AppVerse.
            </p>
            ...
            >
                ...
                <input
                    type="submit"
                    value="Create Developer Account"
                />
