...
public interface UserService {
    ...
    // * @throws com.appverse.user_service.exception.DuplicateResourceException if a
    // user with the same keycloakUserId, username, or email already exists.
    // */
    ...
    // * @throws com.appverse.user_service.exception.ResourceNotFoundException if no
    ...
    // * @return UserResponse DTO of the found user.
    // * @throws com.appverse.user_service.exception.ResourceNotFoundException if no
    // user is found with the given Keycloak ID.
    // */
    // UserResponse getUserByKyloakUserId(String keycloakUserId); // Note: Corrected
    // typo from "Kyloak" to "Keycloak"
    ...
    // * @return UserResponse DTO of the found user.
    // * @throws com.appverse.user_service.exception.ResourceNotFoundException if no
    // user is found with the given email.
    // */
    ...
    // * @throws com.appverse.user_service.exception.ResourceNotFoundException if no
    // user is found with the given ID.
    // * @throws com.appverse.user_service.exception.DuplicateResourceException if
    // the update would cause a username/email conflict.
    // */
    ...
    // * The current entity has a `status` field, suggesting soft delete is an
    // option.
    // *
    ...
    // user is found with the given ID.
    // */
    // void deleteUser(UUID userId); // Or `UserResponse softDeleteUser(UUID
    // userId);`
    ...
    // * @param isAdminAction True if this action is performed by an admin (affects
    // deactivatedByAdmin flag).
    // * @return UserResponse DTO of the updated user.
    // * @throws com.appverse.user_service.exception.ResourceNotFoundException if no
    // user is found with the given ID.
    // */
    // UserResponse updateUserStatus(UUID userId, UserStatus newStatus, boolean
    // isAdminAction);
    ...
    // // --- Existence Checks (useful for validation before creation or for other
    // services) ---
